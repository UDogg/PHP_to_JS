        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('updated-Email-template',$EmailUpdateview->id) }}" method="POST">
                            @csrf
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" value={{ $EmailUpdateview->stage }} name="stage"/>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="session_content" class = "required">Subject</label>
                                            <textarea class="form-control" name="subject" >{{ $EmailUpdateview->subject}}</textarea>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="broker_name" class = "required">body</label>
                                            <textarea class="form-control" name="body" >{{ $EmailUpdateview->body}}</textarea>
                                        </div>
                                    </div>
