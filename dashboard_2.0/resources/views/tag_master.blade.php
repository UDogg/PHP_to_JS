...
@section('content')
    ...
    <section class="content">
        ...
        <div class="card card-secondary">
            <div class="card-header">
                <h3 class="card-title">Tag Master</h3>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" maxlength="50" name="tag_name" class="form-control"
                                    id="tag_name" placeholder="Enter Tag Name">
                        ...
                        @foreach ($faq as $faqs)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button class="btn btn-sm btn-danger delete-sst" data-id="{{ $faqs->tag_id }}">
                                        Delete
                                    </button>
                                </td>
                            </tr>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editStatusModalLabel">Edit Tag Name</h5>
                        ...
                        <div class="modal-body">
                            <form id="editfieldForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="field_master_lob" name="tag_name">
                                </div>
    ...
    <script src="{{ asset('Js/tag_master.js') }}"></script>
