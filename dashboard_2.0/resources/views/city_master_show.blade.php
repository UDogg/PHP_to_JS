                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            @endif
                            <a class="btn btn-dark float-right" href="{{ route('city_master.create') }}">ADD <i
                        ...
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach ($city_master as $data)
                                        <tr>

                                            <td>{{ $data->city_name }}</td>
                                            <td>
                                                <form action="{{ route('city_master.destroy', $data->city_id) }}"
                                                    method="post" onsubmit="return confirm('Are you sure to delete this city..?')"
                                                ...
                                                <a href="{{ route('city_master.edit', $data->city_id) }}"
