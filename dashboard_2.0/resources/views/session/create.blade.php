                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="time" class="form-control" id="session_time"
                                                placeholder="Session Time" name="session_time"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="session_content" class="form-control" id="session_content"
                                                placeholder="Enter Session Content" name="session_content"
                                                value="{{ old('session_content') }}" required>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <select id="broker_name" name="broker_name" class="form-control" required>
                                                ...
                                                @foreach ($brokerNames as $brokerName)
                                                    <option value="{{ $brokerName }}"
                                                        {{ old('broker_name') == $brokerName ? 'selected' : '' }}>
                                                        {{ $brokerName }}
                                                    </option>
                                                @endforeach
